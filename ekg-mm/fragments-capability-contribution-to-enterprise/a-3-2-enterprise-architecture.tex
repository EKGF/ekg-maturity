...
Therefore, implementing an Enterprise Architecture\index{enterprise!architecture} may bring several business benefits:
...
\begin{itemize}
    ...
    \item \textbf{Increased management satisfaction:} By departing from an Operating Model\index{operating model}
          and Enterprise Architecture\index{enterprise!architecture}
