...
\begin{itemize}
  \item a \textit{Business Canvas}\index{business!canvas} models and elaborates \iindex{value proposition},
        \iindex{data!infrastructure}, customers, and finances as aligned activities with potential trade-offs.
