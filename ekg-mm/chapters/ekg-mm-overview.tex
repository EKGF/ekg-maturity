...
\begin{table}[ht]
    ...
    \cellPB         & \labelCD{2}{2}     & \labelKB{2-2} & \taglineB{2-2} \\
    ...
    \labelPD{9}{b}  & \labelCD{4}{4}     & \labelKB{4-4} & \taglineB{4-4} \\
    % C. Technology
    \cellPC         & \cellCT            & \labelKC{1-1} & \taglineC{1-1} \\ % C.1 Technology Strategy
    \cellPC         & \cellCT            & \labelKC{1-2} & \taglineC{1-2} \\
    \cellPC         & \cellCT            & \labelKC{1-3} & \taglineC{1-3} \\
    ...
    \cellPD         & \cellCO            & \labelKD{2-1} & \taglineD{2-1} \\
    ...
    \cellPD         & \cellCO            & \labelKD{3-1} & \taglineD{3-1} \\
