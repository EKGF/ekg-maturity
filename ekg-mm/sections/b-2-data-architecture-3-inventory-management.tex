\section{Inventory Management}\label{sec:ekg-mm-b-2-3} % B.2.3 Inventory Management

A \iindex{Data Inventory} is a repository of \iindex{data assets} for the organization (also known as a
\iindex{data catalog} or \iindex{metadata repository}).
The inventory contains information about what data exists, where it resides (“\iindex{data-at-rest}”),
responsible parties, upstream/downstream usage, how it moves (“\iindex{data-in-motion}”), classifications,
quality designations, availability, and other useful \iindex{metrics}.
...
\begin{scoring}
  ...
  \item \iindex{Data quality} is automatically calculated (fine-grained with dynamic value resolution) within
