...
The digitalization\index{digitalization} of everything (\glsxtrshort{iot}, edge computing\index{edge computing},
digital transform\index{digital!transformation}) has created a fluid context for change,
and the need to decentralize decision-making to keep pace with exponential change and complexity
requires non-linear thinking\index{non-linear thinking}, planning, and execution.
