\section{Critical Data Elements}\label{sec:ekg-mm-b-4-5} % B.4.5 Classification Management
...
\glsfmtlongpl{cde} are defined by \iindex{data quality} business rules and expressed as
