%
% C.2.2 Business Vocabularies (formerly called Business Terminology (formerly called Business Glossary))
%
\ekgmmCapability{c-2-2}{business-vocabularies}{Business Vocabularies}
\index{business!vocabularies}
\index{business!glossary}
\index{glossary!business}
\index{business!terminology}

\ekgmmCapabilityContributionToEnterprise{c-2-2}

\ekgmmCapabilityContributionToEKG{c-2-2}
...
\begin{maturity-dimensions}
  ...
  \item Relationship to official business glossaries\index{business!glossary}\index{glossary!business} or data dictionaries\index{data!dictionary}
...
\begin{level-assessment}{c-2-2}{4}
