...
\begin{itemize}[leftmargin=2in,font=\bfseries]
  ...
  \begin{itemize}[labelwidth=1.5in,leftmargin=0in]
    ...
    \item [Business Unit Goals] Support of the \acrshort{ekg} value proposition\index{EKG Value Proposition} by key \acrshort{lob} stakeholders\index{Stakeholders}
