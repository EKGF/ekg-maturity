...
To address the incongruity, describe above, an experiment has been made to express the \glsfmtshort{ekgmm} using Essence. To do this, using the Essence
...
This diagram is a graphical representation of \glsfmtshort{ekgmm} expressed in Essence, showing the areas of concern, alphas and levels in the style used for
