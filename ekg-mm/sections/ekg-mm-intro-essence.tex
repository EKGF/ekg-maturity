...
\iindex{Essence} is a radical approach to software engineering methods originated by \gls{semat}, and now an \gls{omg} standard.
...
\section{\glsfmtshort{kgmethod}}\label{subsec:agnos-ai-kg-method}
...
\section{\glsfmtshort{ekgmm} Essence kernel and practices}\label{subsec:kg-mm-essence-kernel-and-practices}
