\subsection{Scoring Overview}

The \glsfmtlong{ekgmm} is a capability model designed to promulgate best practices across the knowledge graph community.
It covers essential capabilities as well as standard evaluation criteria required for the design, implementation,
and maintenance of an \glsfmtlong{ekg}.
...
\subsubsection{Level 1: \glsfmtshort{ekg} Initiation (minimum viable product)}
...
\subsubsection{Level 2: Extensible Platform (reusable components)}
...
\begin{itemize}[leftmargin=1in]
    ...
    \item[Data]         Inventory is embedded into the \glsfmtshort{ekg} and linked to governance.
                        Data is expressed as formal ontologies, onboarded into the \glsfmtshort{ekg} and searchable.
                        Data flows are defined and modeled.
                        The \glsfmtshort{ekg} is the authoritative source for data.
    \item[Technology]   Commitment to the \glsfmtshort{ekg} as the strategic infrastructure for the organization.
    ...
    \item[Organization] The \glsfmtshort{ekg} is recognized as a core service for the enterprise.
...
The \glsfmtshort{ekg} is understood as strategic infrastructure for the organization and the authoritative source
for all data.
...
The \glsfmtshort{ekg} is central to systems and business processes.
...
Entitlements and access rights are controlled by the \glsfmtshort{ekg}.
