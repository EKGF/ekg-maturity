\section[Operating Model]{Data-management \Glsfmttext{operating-model}}\label{sec:ekgmm-b-4-1} % B.4.1 Operating Model
...
organization’s customers.\footnote{%
    There is also a capability called ``\nameref{sec:ekgmm-a-1-4}'' in the
    Business Pillar that has a different meaning, see \secref{sec:ekgmm-a-1-4}.
}
...
The \gls{operating-model} for the \glsfirst{ekg:coe} establishes a new way of running the organization to enable companies to
