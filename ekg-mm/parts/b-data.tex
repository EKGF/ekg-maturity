...
\begin{description}[nosep,font=\bfseries]
    ...
    Core data management capabilities (\gls{operating-model}, inventory, data architecture, business
...
\input{../../ekg-mm/chapters/b-data-1-data-strategy.tex}
\input{../../ekg-mm/chapters/b-data-2-data-architecture.tex}
\input{../../ekg-mm/chapters/b-data-3-data-quality.tex}
\input{../../ekg-mm/chapters/b-data-4-data-governance.tex}
