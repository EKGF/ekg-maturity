%
% B.2.1 Ontologies -- Summary
%
Within an \gls{ekg}, ontologies\index{ontology} are the models that provide the structure and meaning of the information.
...
%Previous content:
%%
%% B.2.1 Identity Resolution -- Summary
%%
