...
All capabilities that we measure in the \glsxtrshort{ekgmm} are categorized in four major categories that match the four primary audiences that are involved:
...
\input{../content/sections/ekg-mm-intro-model-overview-maturity-levels.tex}

\input{../content/sections/ekg-mm-intro-model-overview-scoring-levels.tex}
