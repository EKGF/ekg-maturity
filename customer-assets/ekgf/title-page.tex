...
%    \hline
     ...
     & {\scriptsize \textcolor{primarySubText}{\today, Version \documentVersion}} \\ % \cline{2-2}
     & {\scriptsize \textcolor{primarySubText}{\ifoptionfinal{}{(editor's version with comments \& to-dos)}}} \\ % \hline
  \end{tabular}\\[1cm]
  %
  % Import the banner and size it across the whole page
  %
  ...
  \iftoggle{showLicenceCreativeCommonsBySa}{
      ...
      \textcolor{primarySubText}{
          \copyright~\the\year~\authorLegalName.\newline
