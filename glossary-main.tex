...
\newglossaryentry{cde}{
    ...
    description={%
        this concept is defined in many ways.
        ...
        See also
        \chapterref{sec:ekg-mm-classification-management}{Classification Management}{\glsfmtshort{ekgmm}}.
    }
}
...
\newglossaryentry{iri}{
    ...
    type=\glsdefaulttype,%
    short={IRI},
    long={Internationalised Resource Identifier},
    first="Internationalised Resource Identifier (IRI)",
    firstplural="Internationalised Resource Identifiers (IRIs)",
    description={%
        a standard defined by the \gls{ietf} in 2005 in \href{https://datatracker.ietf.org/doc/html/rfc3987}{RFC 3987}.
        An Internationalized Resource Identifier (IRI) is defined similarly to a \glsxtrshort{uri},
