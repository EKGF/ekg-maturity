...
\begin{enumerate}
    \item Much higher levels of \iindex{transparency}, \iindex{sustainability}, \iindex{fairness} and
          \iindex{accountability} are going to be required at all levels in any organization
    \item Human Capital\index{human capital} needs to be known, valued, leveraged and optimized
    \item Data Capital\index{data!capital} needs to be known, valued, leveraged and optimized
    \item Increasing \iindex{competitiveness} depends more and more on having the highest quality and depth of data,
          information and knowledge\index{data!quality}
    \item One "censored"\index{censoring}, biased, \glsfirst{svot} is no longer good enough for many\,---\,if not
...
\begin{enumerate}
    ...
    \item We embrace the \textit{Open World}\footnote{Does not mean all data is open to everyone} and deal
          with the realities of \enquote{\gls{mvot}}.\improve{This is a data-geek sentence}
...
\begin{enumerate}
    ...
    \item All representations of any given object shall be linked via shared identifiers.
          \begin{itemize}
              \item Identifiers shall be meaningless, opaque, web-resolvable and universally unique.
                    See principle~\ref{sec:ekg-principles-identity}.\index{principles!Identity}
    ...
    \item Every "object" that is represented as data in whichever dataset anywhere, shall have an identifier
          ...
          See \ref{sec:ekg-principles-identity}~\nameref{sec:ekg-principles-identity}.\index{principles!Identity}
\end{enumerate}
