...
\part{Technology Pillar}\label{pt:ekg-maturity-d} % D Technology Pillar

The \currentname has the following components:

\begin{itemize}[leftmargin=.5in]
    \item [\ref{ch:ekg-maturity-d-1}] \nameref{ch:ekg-maturity-d-1}
    \item [\ref{ch:ekg-maturity-d-2}] \nameref{ch:ekg-maturity-d-2}
    \item [\ref{ch:ekg-maturity-d-3}] \nameref{ch:ekg-maturity-d-3}
\end{itemize}
...
\input{../../ekg-maturity/chapters-d-technology-pillar/d-1-technology-strategy.tex}
\input{../../ekg-maturity/chapters-d-technology-pillar/d-2-technology-execution.tex}
\input{../../ekg-maturity/chapters-d-technology-pillar/d-3-user-interface.tex}
