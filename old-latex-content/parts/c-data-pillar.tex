...
\part{Data Pillar}\label{pt:ekg-maturity-c} % C Data Pillar

The \currentname has the following components:

\begin{itemize}[leftmargin=.5in]
  \item [\ref{ch:ekg-maturity-c-1}] \nameref{ch:ekg-maturity-c-1} % C.1 Data Strategy
  \item [\ref{ch:ekg-maturity-c-2}] \nameref{ch:ekg-maturity-c-2} % C.2 Data Architecture
  \item [\ref{ch:ekg-maturity-c-3}] \nameref{ch:ekg-maturity-c-3} % C.3 Data Quality
  \item [\ref{ch:ekg-maturity-c-4}] \nameref{ch:ekg-maturity-c-4} % C.4 Data Governance
\end{itemize}
...
\input{../../ekg-maturity/chapters-c-data-pillar/c-1-data-strategy.tex}
\input{../../ekg-maturity/chapters-c-data-pillar/c-2-data-architecture.tex}
\input{../../ekg-maturity/chapters-c-data-pillar/c-3-data-quality.tex}
\input{../../ekg-maturity/chapters-c-data-pillar/c-4-data-governance.tex}
