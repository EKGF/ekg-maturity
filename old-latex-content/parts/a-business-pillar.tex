...
\part{Business Pillar}\label{pt:ekg-maturity-a} % A Business Pillar

\input{../../ekg-maturity/chapters-a-business-pillar/a-0-background-and-intro.tex}

%The pillar "Business" has the following components:
%
%\begin{itemize}[leftmargin=.5in]
%    \item [\ref{ch:ekg-maturity-a-1}] \nameref{ch:ekg-maturity-a-1}
%    \item [\ref{ch:ekg-maturity-a-2}] \nameref{ch:ekg-maturity-a-2}
%    \item [\ref{ch:ekg-maturity-a-3}] \nameref{ch:ekg-maturity-a-3}
%\end{itemize}
%
%\paragraph{Levels}
%
...
\input{../../ekg-maturity/chapters-a-business-pillar/a-1-business-strategy-actuation.tex}
\input{../../ekg-maturity/chapters-a-business-pillar/a-2-business-model-elaboration.tex}
\input{../../ekg-maturity/chapters-a-business-pillar/a-3-business-enablers.tex}
