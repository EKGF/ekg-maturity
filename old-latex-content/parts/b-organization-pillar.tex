...
\part{Organization Pillar}\label{pt:ekg-maturity-b} % B Organization Pillar

The \currentname has the following components:

\begin{itemize}[leftmargin=.5in]
    \item [\ref{ch:ekg-maturity-b-1}] \nameref{ch:ekg-maturity-b-1}
    \item [\ref{ch:ekg-maturity-b-2}] \nameref{ch:ekg-maturity-b-2}
    \item [\ref{ch:ekg-maturity-b-3}] \nameref{ch:ekg-maturity-b-3}
    \item [\ref{ch:ekg-maturity-b-4}] \nameref{ch:ekg-maturity-b-4}
    \item [\ref{ch:ekg-maturity-b-5}] \nameref{ch:ekg-maturity-b-5}
\end{itemize}
...
\input{../../ekg-maturity/chapters-b-organization-pillar/b-1-executive-leadership.tex}
\input{../../ekg-maturity/chapters-b-organization-pillar/b-2-product-ownership.tex}
\input{../../ekg-maturity/chapters-b-organization-pillar/b-3-delivery-management.tex}
\input{../../ekg-maturity/chapters-b-organization-pillar/b-4-organizational-culture.tex}
\input{../../ekg-maturity/chapters-b-organization-pillar/b-5-organizational-capabilities.tex}
