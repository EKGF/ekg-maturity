...
\begin{enumerate}[label=(\alph*)]
    ...
    \item Platform Services\,---\,the emphasis that utility of services is increasingly determined not from clarity of
          ...
          digital platforms\index{digital!platform} by 2025.\autocite{ifyourenotbuilding}
...
which is where practices around agility, DevOps\index{DevOps!see {EKGOps}} etc are increasingly mainstream.
...
strategy\footnote{See \Nameref{ch:ekg-maturity-what-is-strategy}},
...
\sectionNoNumber{Business Identity}\label{sec:ekg-maturity-business-identity}

\nameref{sec:ekg-maturity-business-identity} is a statement of a company's unique innovation, service, and/or product based
value proposition.\index{value proposition}
A \nameref{sec:ekg-maturity-business-identity}, published to the world via business identifier unique \glsxtrlongpl{ekg},
...
realizing business strategy, through the lens of \nameref{sec:ekg-maturity-business-identity}\index{business!identity}
and Contracts:

\begin{enumerate}
    \item \input{../../ekg-maturity/fragments-component-summary/a-1.tex}
    ...
    \item \input{../../ekg-maturity/fragments-component-summary/a-2.tex}
