...
\TODO[inline]{%
    ...
    See also \ref{ch:ekg-maturity-business-strategy-actuation} \nameref{ch:ekg-maturity-business-strategy-actuation} on page
    \pageref{ch:ekg-maturity-business-strategy-actuation}.
}
