...
\newglossaryentry{object}{
    ...
    type=\glsdefaulttype,%
    description={%
        A knowledge resource, that is intended to be referenceable and shared.
...
\newglossaryentry{canonical-identifier}{
    ...
    type=\glsdefaulttype,%
    description={%
        A permanent identifier for an object, distinguished within an \gls{ekg}.
    }
}
...
\newglossaryentry{linked-data} {
    ...
    description={%
        ...
        It builds upon standard Web technologies such as HTTP, \gls{rdf} and \glspl{uri}/\glspl{iri},
        but rather than using them to serve web pages only for human readers, it extends them to share information
        ...
        Tim Berners-Lee, director of the \glsfirst{w3c}, coined the term in a 2006 design note about the
        Semantic Web project.
        Linked data may also be open data, in which case it is usually described as \glsfirst{lod}.
    }
}
