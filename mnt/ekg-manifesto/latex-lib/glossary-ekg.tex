...
\newglossaryentry{ekg:ekg}{% ekg:ekg the glossary entry
    ...
    name={EKG},
    description={%
        much like "the web" is a virtual concept, an \glsfirst{ekg} is a virtual concept that combines all
...
\newglossaryentry{ekg:coe}{
    ...
    plural={\glspl{coe} for the \gls{ekg}},
...
\newglossaryentry{ekg:architecture:system}{
    ...
    description={%
        the logical \gls{system-architecture} of \gls{ekg} is divided into multiple layers or environments such as
...
\newglossaryentry{ekg:dataops:environment}{
    ...
    description={%
        ...
        data as a \gls{ekg:sdd} in any technical or physical environment, the actual DataOps "environment"
...
\newglossaryentry{ekg:dataops:pipeline}{
    ...
    description={%
        ...
        from a given source and the last step produces an \gls{ekg:sdd} (for "inbound pipelines") or
